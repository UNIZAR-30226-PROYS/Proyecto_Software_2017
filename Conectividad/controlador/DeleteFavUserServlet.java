 ...
 */
public class DeleteFavUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public DeleteFavUserServlet() {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (error.equals("")){
			System.err.println("[DeletFavUser]: No hay error en los parametros");
			...
			try{
				...
				fachada.deleteFavUser(fav);
				resp.sendError(100);
			}catch (Exception e){
				resp.sendError(500, e.getMessage());
				System.err.print("[DeletFavUser]: ");
				e.printStackTrace(System.err);
			}
		}else{
			System.err.println("[DeletFavUser]: Errores encontrados:\n" + error);
